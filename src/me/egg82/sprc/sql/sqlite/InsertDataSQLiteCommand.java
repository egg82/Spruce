...
public class InsertDataSQLiteCommand extends Command {
	//vars
	...
	//constructor
	public InsertDataSQLiteCommand(String ip, boolean value) {
		super();
	...
	public InsertDataSQLiteCommand(String ip, boolean value, long created) {
		super();
